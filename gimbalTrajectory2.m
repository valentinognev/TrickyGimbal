...
for i=1:N
    ...
    test_s(elevation(i),azimuth(i))
    test_s(elev_s(i),az_s(i))
    test_s(elev_s(i),az_s_2(i))
    test_s(elev_s(i),az_s_3(i))
    ...
    test_1(elevation_1(i), azimuth_1(i))
    test_1(elev_1(i), az_1(i))
    test_1(elev_1(i), az_1_2(i))
    test_1(elev_1(i), az_1_3(i))
